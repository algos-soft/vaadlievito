...
public class SpacciatoreDialogEdit extends SpacciatoreDialog {
     ...
     */
    public SpacciatoreDialogEdit(IAService service, Class<? extends AEntity> binderClass) {
